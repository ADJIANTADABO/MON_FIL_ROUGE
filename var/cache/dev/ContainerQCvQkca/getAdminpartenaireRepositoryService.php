...
// Returns the private 'App\Repository\AdminpartenaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdminpartenaireRepository.php';

return $this->privates['App\\Repository\\AdminpartenaireRepository'] = new \App\Repository\AdminpartenaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
