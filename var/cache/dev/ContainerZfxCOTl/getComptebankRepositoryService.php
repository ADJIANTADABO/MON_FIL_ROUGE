...
// Returns the private 'App\Repository\ComptebankRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ComptebankRepository.php';

return $this->privates['App\\Repository\\ComptebankRepository'] = new \App\Repository\ComptebankRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
